...
pub fn PageAlert(cx: Scope) -> impl IntoView {
    ...
    view! { cx,
        ...
        <Alert variant=AlertVariant::Success title="asd" centered=center_alert>"Success alert"</Alert>
        <Alert variant=AlertVariant::Info title="asd" centered=true>"Info alert"</Alert>
